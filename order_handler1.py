...
ORDER_API_ENDPOINT = "https://personal-4acjyryg.outsystemscloud.com/Order/rest/v1/order/status/{order_id}/{status}/"

# Route for updating order status
@app.route('/order/status/<int:order_id>/<string:status>/', methods=['PUT'])
